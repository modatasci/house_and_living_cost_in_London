...
class TravelCalculator:
    ...
    def print_all_journey_options(self, from_location: str, to_location: str) -> Optional[Dict]:
        """
        ...
        if self.all_journeys is not None:
            journeys = self.all_journeys
        else:
    ...
    def select_journey_option(self, from_location: str, to_location: str, **kwargs) -> Optional[Dict]:
        ...
        # save journeys to self.all_journeys for later use
        ...
        self.print_all_journey_options(from_location, to_location)
